...
public class UsuarioRequest {
    ...
    public UsuarioRequest(String rollUser, Long id_persona, String nombreUser, String apellidosUser,
            String fechaNacimeinto, String correoUser, BigInteger newTelefono, String contraseniaUser) {
    ...
    public void setNombreoUser(String nombreUser) {
        this.nombreUser = nombreUser;
    }

    public void setFechaUser(String fechaNacimeinto) {
        this.fechaNacimeinto = fechaNacimeinto;
    }
    ...
    public void setTelefonoUser(BigInteger newTelefono) {
        this.newTelefono = newTelefono;
    }
