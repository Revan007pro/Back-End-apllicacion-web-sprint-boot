...
public Map<String, Object> crearFactura(@RequestBody FacturaRequest factuCita) {
...
public ResponseEntity<List<PrecioTServicio>>traerFactura(@PathVariable Long idCita){
    ...
    return ResponseEntity.ok(facturaCita); // retorna la info necesaria para ver en el front
