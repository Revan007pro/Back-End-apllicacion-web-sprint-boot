...
public class GuardarUsuario {
    ...
    public ResponseEntity<Map<String, Object>> respuestaSave(@RequestBody SaveRequest newSave) {
        ...
        Integer newEstado = newSave.getEstadoSave();
        ...
        if (newEstado == null) {
            userSave2.put("code", "10");
            userSave2.put("mensaje", "el estado no esta bien seteado");
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(userSave2);
        }
